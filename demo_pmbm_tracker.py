...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 25 17:32:44 2019
...
# build scene
if scenario == 'linear':
    scene = LinearScenario.caseC(birth_weight=0.0005, birth_cov_scale=400)
    ...
    scene = NonlinearScenario.caseC(birth_weight=0.001)
    birth_model = scene.birth_model
...
density_model = KalmanAccumulatedDensityModel(traceback_range=10)
