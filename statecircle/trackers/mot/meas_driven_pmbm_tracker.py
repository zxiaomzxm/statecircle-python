...
Created on Wed Mar 25 16:03:24 2020
...
class MeasDrivenPMBMTracker(PMBMFilter):
    ...
    def __init__(self, prior_birth, surviving_rate, recycle_threshold, prob_min, prob_estimate, 
        ...
        super(MeasDrivenPMBMTracker, self).__init__(surviving_rate, recycle_threshold, prob_min, prob_estimate, *args, **kwargs)
    ...
    def update(self, step, meas_data):
        ...
        for j in range(num_meas):
            if num_birth > 0:
                Bern, lik_new = self.PPP_detected_update(step, 
